...
curl -sSfL https://github.com/AshAvalanche/ash-rs/releases/download/v0.2.1/ash-linux-amd64-v0.2.1.tar.gz -o ash-linux-amd64-v0.2.1.tar.gz
curl -sSfL https://github.com/AshAvalanche/ash-rs/releases/download/v0.2.1/ash-linux-amd64-v0.2.1.tar.gz.sha512 | sha512sum -c --quiet
tar -xzf ash-linux-amd64-v0.2.1.tar.gz && chmod +x ash
rm ash-linux-amd64-v0.2.1.tar.gz
